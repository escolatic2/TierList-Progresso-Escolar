...
let teamsData = [
    { id: 1, name: "Os Batatas", points: 75, imageUrl: "images/osbatatas.jpg" },
    { id: 2, name: "The Best", points: 85, imageUrl: "images/thebest.png" },
    { id: 3, name: "Os Laggers", points: 60, imageUrl: "images/oslaggers.jpg" },
...
const TIER_RULES = [
    { tier: "S", minPoints: 85, label: "Tier S (Atingiu o Objetivo Máximo)" },
    { tier: "A", minPoints: 75, label: "Tier A (Excelente Progresso)" },
    { tier: "B", minPoints: 65, label: "Tier B (Bom Progresso)" },
    { tier: "C", minPoints: 55, label: "Tier C (Avança de Forma Constante)" },
    { tier: "D", minPoints: 45, label: "Tier D (A Começar)" }
];
